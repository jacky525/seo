...
class SitemapBuilder implements SitemapBuilderInterface
{
	...
	{
		$this->domain = $domain;
		$this->options = array_merge($this->options, isset($options) ?$options: []);
		$urlset = '<!-- Generated by https://git.io/phpseo --><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" ';
	 ...
	 * @return string
	 */
	protected function getByRelativeUrl( $url)
	{
		if (strpos($url, '://') === false) {
	 ...
	 * @return string
	 */
	protected function pasreDate($date)
	{
